...
class UserInfo(AbstractUser):
    ...
    avatar = models.FileField(upload_to="head_img/", default="head_img/default.png", verbose_name="头像")
...
#     user = models.OneToOneField(to="UserInfo", to_field="nid", null=True)
#
#     def __str__(self):
#         return self.title
#
...
class ArticleUpDown(models.Model):
    ...
    class Meta:
        ...
        verbose_name = '点赞表'             # 起表名
        verbose_name_plural = verbose_name  # 去掉中文显示页面后边的s
...
class Comment(models.Model):
    ...
    create_time = models.DateTimeField(auto_now_add=True)
    parent_comment = models.ForeignKey("self", null=True, blank=True)  # blank=True；在Django admin中可以为空

    def __str__(self):
        return self.content

    class Meta:
        verbose_name = '评论表'  # 起表名
        verbose_name_plural = verbose_name  # 去掉中文显示页面后边的s
